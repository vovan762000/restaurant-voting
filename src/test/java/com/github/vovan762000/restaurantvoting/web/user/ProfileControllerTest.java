...
import static com.github.vovan762000.restaurantvoting.web.vote.VoteTestData.userVotes;
...
class ProfileControllerTest extends AbstractControllerTest {
    ...
    void register() throws Exception {
        UserTo newTo = new UserTo(null, "newName", "newemail@github.com", "newPassword");
