...
public class VoteTestData {
    ...
    public static final Vote USER_VOTE_1 = new Vote(USER_VOTE_1_ID, of(2022, 1, 1, 11, 0), RestaurantTestData.RESTAURANT_1, user);
    public static final Vote USER_VOTE_2 = new Vote(USER_VOTE_2_ID, of(2022, 2, 1, 11, 0), RestaurantTestData.RESTAURANT_2, user);
    public static final Vote USER_VOTE_3 = new Vote(USER_VOTE_3_ID, of(2022, 8, 1, 11, 0), RestaurantTestData.RESTAURANT_1, user);
    public static final Vote ADMIN_VOTE_1 = new Vote(ADMIN_VOTE_1_ID, of(2022, 1, 1, 14, 0), RestaurantTestData.RESTAURANT_1, admin);
    public static final Vote ADMIN_VOTE_2 = new Vote(ADMIN_VOTE_2_ID, of(2022, 6, 1, 17, 0), RestaurantTestData.RESTAURANT_1, admin);
